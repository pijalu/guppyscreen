...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(harmonyos_sans_8) LV_FONT_DECLARE(harmonyos_sans_10) LV_FONT_DECLARE(harmonyos_sans_12)

/*Always set a default font*/
#define LV_FONT_DEFAULT &harmonyos_sans_10
